...
class Zend_Filter_InputTest extends PHPUnit\Framework\TestCase
{
    ...
    */
    public function testNoNestedMessageArrays()
    {
        ...
        $messages = $input->getMessages();
        $this->assertIsNotArray($messages['field1']['isEmpty'], 'oh oh, we  may have got nested messages');
    ...
    public function testValidatorSingleInvalid()
    {
        ...
        $this->assertIsArray($messages['month']);
        ...
        $this->assertIsArray($errors['month']);
    ...
    public function testValidatorChain()
    {
        ...
        $this->assertIsArray($messages['field2']);
        $this->assertIsArray($messages['field3']);
    ...
    public function testValidatorInvalidFieldInMultipleRules()
    {
        ...
        $this->assertIsArray($messages['field2a']);
        $this->assertIsArray($messages['field2b']);
        $this->assertEquals(
            "'abc123' must contain only digits",
            current($messages['field2a'])
        );
        $this->assertEquals(
            "'abc123' is not between '1' and '100', inclusively",
    ...
    public function testValidatorMultiField()
    {
        ...
        $this->assertEquals(
            'Not all strings in the argument are equal',
    ...
    public function testValidatorAllowEmptySetNotEmptyMessage()
    {
        ...
        $this->assertIsArray($messages['field1Rule']);
    ...
    public function testGetPluginLoader()
    {
        ...
        $this->assertInstanceOf(
            Zend_Loader_PluginLoader::class, $loader,
        ...
        try {
            ...
            $this->assertInstanceOf(
                Zend_Filter_Exception::class, $e,
                'Expected object of type Zend_Filter_Exception, got ' . get_class($e)
            );
            $this->assertEquals(
                'Invalid type "foo" provided to getPluginLoader()',
                $e->getMessage()
            );
        }
    }
    ...
    public function testSetPluginLoaderInvalidType()
    {
        ...
        try {
            ...
            $this->assertEquals(
                'Invalid type "foo" provided to setPluginLoader()',
                $e->getMessage()
            );
        }
    }
    ...
    public function testNamespaceExceptionClassNotFound()
    {
        ...
        try {
            ...
            $this->assertInstanceOf(
                Zend_Loader_PluginLoader_Exception::class, $e,
                'Expected object of type Zend_Filter_Exception, got ' . get_class($e)
            );
    ...
    public function testNamespaceExceptionInvalidClass()
    {
        ...
        try {
            ...
            $this->assertEquals(
                "Class 'Zend_Validate_Exception' based on basename 'Exception' must implement the 'Zend_Validate_Interface' interface",
                $e->getMessage()
            );
        }
    }
